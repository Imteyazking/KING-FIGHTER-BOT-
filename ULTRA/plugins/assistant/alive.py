...
async def awake(event):
  ...
  BUTTON = [[Button.url("Mᴀsᴛᴇʀ", f"https://t.me/{bot.me.username}"), Button.url(f"{BOT} Rᴇᴘᴏ", "https://github.com/Imteyazking/KING-FIGHTER-BOT-")]]
...
# inline by LEGENDX22 and PROBOY22 🔥
  PROBOYX = [[Button.url("Rᴇᴘᴏ King Fighter", "https://github.com/Imteyazking/KING-FIGHTER-BOT-")]]
  PROBOYX +=[[Button.url("Dᴇᴘʟᴏʏ King Fighter", "https://dashboard.heroku.com/new?button-url=https://github.com/Imteyazking/KING-FIGHTER-BOT-&template=https://github.com/Imteyazking/KING-FIGHTER-BOT-")]]
  ...
  PROBOYX +=[[Button.url("Sᴜᴘᴘᴏʀᴛ Cʜᴀɴɴᴇʟ", "https://t.me/Imteyaz_info"), Button.url("Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ", "https://t.me/King_fighter_Bot_support")]]
...
# inline by LEGENDX22 and PROBOY22 🔥
  ...
  LEGENDX += "**Tᴇʟᴇᴛʜᴏɴ** : `1.20`\n\n"
  LEGENDX += "~~ **Tʜᴀɴᴋs ғᴏʀ ᴄʜᴇᴄᴋɪɴɢ ᴍᴇ** !!"
  BUTTONS = [[Button.url("Mᴀsᴛᴇʀ", f"https://t.me/{bot.me.username}"), Button.url(f"{BOT} Rᴇᴘᴏ", "https://github.com/Imteyazking/KING-FIGHTER-BOT-")]]
...
async def repo(event):
  await xbot.send_message(event.chat, "**Hᴇʀᴇ Is Tʜᴇ Rᴇᴘᴏ Fᴏʀ King Fighter Usᴇʀʙᴏᴛ** \n\nFᴏʀ Aɴʏ Hᴇʟᴘ :- @King_fighter_Bot_support", buttons=[[Button.url("⚜️ Rᴇᴘᴏ ⚜️", "https://github.com/Imteyazking/KING-FIGHTER-BOT-"), Button.url("🔰 Dᴇᴘʟᴏʏ 🔰", "https://dashboard.heroku.com/new?button-url=https://github.com/Imteyazking/KING-FIGHTER-BOT-&template=https://github.com/Imteyazking/KING-FIGHTER-BOT-")]])
